...
namespace QOptions.Core.Extensions
{
    ...
    public static class QueryGeneratorExtensions
    {
        ...
        {
            return sourceType != null ? new EntityQueryOptions<TEntity>() : throw new ArgumentException();
        }
        ...
        {
            return sourceType != null ? new QueryOptions<TModel>() : throw new ArgumentException();
        }
        ...
        ///  <returns>Updated query options</returns>
        /// <exception cref="ArgumentNullException">If query options, key selector or value is null</exception>
        public static IQueryOptions<TModel> AddPagination<TModel>(this IQueryOptions<TModel> options, int pageSize, int pageToken)
            where TModel : class
        {
            if (options == null)
                throw new ArgumentException();
